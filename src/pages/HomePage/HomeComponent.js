...
export default function HomeComponent() {
  ...
  // const [currentNewsIndex] = useState(0); // Removing currentNewsIndex as we only show top 1
          ...
          <main className="flex-1 p-4 overflow-auto ">
            ...
            <div className="mt-6">
              ...
              {!loadingNews && topNews.length > 0 ? (
                ...
                <div className="mb-6 h-64 flex items-center justify-center bg-white/5 rounded-lg border border-white/10">
                   <p className="text-white/50">{loadingNews ? "Loading top news..." : "No news in the last 24h"}</p>
                </div>
              )}
